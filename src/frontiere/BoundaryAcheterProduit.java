...
public class BoundaryAcheterProduit {
	...
	public void acheterProduit(String nomAcheteur) {
		...
		if(produitPresent ==false) {
			...
			int IndiceVendeur = numVendeur-1; //Car numVendeur commence à 1 alors que les indices commencent à 0
			...
			if(quantiteEntier == 0) {
				...
				quantiteEntier = 0;
				//Ici est-ce suffisant pour modifier la quantité de produit à la racine ? Je ne pense pas.
			}
			else {
				...
				//Pareil ici, je ne pense pas que dans le cas ou on achète plusieurs fois le même article à un même vendeur, cela soit fonctionnel.
			}
