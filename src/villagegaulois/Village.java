...
public class Village {
	...
	public int installerVendeur(Gaulois vendeur, String produit,
		...
		if (indiceEtal >= 0) {
			...
			//System.out.println("C'est un test mais on est là ! \n");
		}
		return indiceEtal;
	}
	...
	private static class Marche {
		...
		private void utiliserEtal(int indiceEtal, Gaulois vendeur,
			...
			if (indiceEtal >= 0 && indiceEtal < etals.length) {
				//System.out.println("Utiliser etal de village \n");
				etals[indiceEtal].occuperEtal(vendeur, produit, nbProduit);
				//System.out.println(etals[indiceEtal].getQuantite());
			}
		}
		...
		private int trouverEtalLibre() {
			...
			//System.out.println(" indice etal libre :"+indiceEtalLibre+"\n");
